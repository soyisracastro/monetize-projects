...
- **RESICO 2026 — Tip para la opción h).** Si tu cliente te pregunta qué régimen le conviene y factura menos de $3.5M anuales, RESICO sigue siendo una opción muy competitiva: tasas de ISR del 1% al 2.5%, sin declaración anual para la mayoría de contribuyentes, y pagos mensuales definitivos. Pero ojo: a partir de 2026 hay nuevas sanciones por no emitir CFDI en RESICO. Explícale los pros y contras con este prompt.
