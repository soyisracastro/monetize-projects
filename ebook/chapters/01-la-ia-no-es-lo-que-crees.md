...
Y esto importa para ti como contador porque significa que la IA que conoces hoy no es la IA que vas a usar en seis meses. Los conceptos que aprendas ahora van a seguir siendo válidos; las herramientas específicas, no necesariamente. Por eso este libro se enfoca en conceptos, no en botones.
...
**Google** tiene Gemini, que integra directamente en su ecosistema: búsqueda, correo, documentos. Su ventaja es que puede conectarse con toda la información que ya tienes en sus servicios.
